...
def get_text_call(filename, trees_improve_iter=None, trees_count=None, block_size=None, RLE=None, SSF=None, RHS=None):
...
# RHS?
print("RHS")
for rhs in ["false", None]:
    yy = []
    for f in filenames:
        filename = cantrbry_path + f
        
        cmdtext = get_text_call(filename, RHS=rhs)
